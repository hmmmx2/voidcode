...
| vLLM serve of the AWQ model | **Not yet demonstrated.** The artifact exists and is structurally valid, but it has not been loaded by vLLM and asked to generate. Do not claim end-to-end serving until it has. |
