...
// Ported from the website's `components/auth/StrengthMeter.tsx` when sign-in moved into the desktop app. The website is
// being removed, so this is now the only copy.
import { estimateStrength } from "@/lib/account/validation";
