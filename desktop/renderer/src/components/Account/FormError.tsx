// Ported from the website's `components/auth/FormError.tsx` when sign-in moved into the desktop app. The website is
 ...
 * more than usual here: the error replaces a form the person just submitted, so a sighted user sees
 * the change and a non-sighted one gets no signal at all unless the message
 * announces itself.
 *
