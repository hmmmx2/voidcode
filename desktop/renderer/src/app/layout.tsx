  ...
  return (
    <html lang="en" className="dark">
      <body className={`${inter.variable} ${jetbrainsMono.variable}`}>
        {/* The shell mounts here, above the router, so panel state and the selected
            destination survive navigation. Per-route-group it would rebuild on every link.
            It renders children bare on the web and on document routes. */}
        <Providers>
